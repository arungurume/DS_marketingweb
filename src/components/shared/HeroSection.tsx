      ...
      <div className="max-w-[1240px] mx-auto px-6">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-24">
            <Button asChild className="bg-[#2B7CD3] hover:bg-[#246BB5] text-white h-14 px-8 text-lg font-normal rounded-lg shadow-lg shadow-blue-500/10 transition-transform hover:scale-[1.02]">
              <a href="https://hub.digitalsigns.ai/#/usermanagement/signin">Sign up free</a>
            </Button>
            <Button variant="outline" className="border-gray-200 bg-white hover:bg-gray-50 text-black h-14 px-8 text-lg font-normal rounded-lg shadow-sm transition-transform hover:scale-[1.02]">
