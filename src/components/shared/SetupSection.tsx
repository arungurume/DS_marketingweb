...
export function SetupSection() {
  ...
  return (
    <section className="relative bg-black text-white pb-24">
      ...
      <div className="absolute bottom-[-200px] left-0 right-0 w-full flex justify-center px-4">
        <div className="max-w-5xl w-full mx-auto">
          <div className="relative h-full max-h-[70%] overflow-hidden">
