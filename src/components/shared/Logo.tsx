  ...
  <div className={cn('flex items-center gap-2', className)}>
    ...
    >
      ...
      <g clipPath="url(#clip0_1_2)">
        ...
        />
        <path
          d="M82.8989 3.824C78.4989 3.824 74.8029 7.52 74.8029 12.016V31.824C74.8029 36.32 78.4989 40 82.8989 40H101.523L101.523 32.176H84.3719C83.4359 32.176 82.6759 31.408 82.6759 30.48V13.328C82.6759 12.4 83.4359 11.632 84.3719 11.632H101.523V3.824H82.8989Z"
          stroke="white"
          strokeWidth="3"
        />
        <path
        ...
        />
        <path
          d="M52.091 1.5H84.395C93.443 1.5 101.443 8.128 101.443 17.488V25.92C101.443 35.28 93.443 41.908 84.395 41.908H52.091C49.931 41.908 48.179 40.156 48.179 38V5.408C48.179 3.248 49.931 1.5 52.091 1.5ZM82.843 38.344C91.115 38.344 97.907 32.224 97.907 24.16V19.264C97.907 11.2 91.115 5.08 82.843 5.08H52.091V38.344H82.843Z"
      stroke="white"
      strokeWidth="3"
    />
      </g>
